...
df[[1]] <- read.csv(
  "../../Raw_Data/Merryn D. Constable_2020_AP/MerrynD.Constable_2020_AP_Exp1_raw.csv"
  ) %>%
  dplyr::filter(
    rt != "None"
  ) %>%
...
summary(df[[1]])
write.csv(x = df[[1]], file = "../../Clean_Data/Merryn D. Constable_2020_AP/Merryn D. Constable_2020_AP_Exp1_Clean.csv")
```
...
df[[2]] <- read.csv(
  "../../Raw_Data/Merryn Dale Constable_2020_CE/Exp1/Merryn Dale Constable_2020_CE_Exp1_raw.csv"
  ) %>%
  # 筛选可以分析的行
  dplyr::filter(
    rt != "None",
...
summary(df[[2]])
write.csv(x = df[[2]], file = "../../Clean_Data/Merryn Dale Constable_2020_CE/Merryn Dale Constable_2020_CE_Exp1_Clean.csv")
```
...
df[[3]] <- read.csv(
  "../../Raw_Data/Merryn Dale Constable_2020_CE/Exp2/Merryn Dale Constable_2020_CE_Exp2_raw.csv"
  ) %>%
  # 筛选可以分析的行
  dplyr::filter(
    rt != "None",
...
summary(df[[3]])
write.csv(x = df[[3]], file = "../../Clean_Data/Merryn Dale Constable_2020_CE_Exp2_Clean.csv")
```
...
df[[4]] <- read.csv(
  "../../Raw_Data/Haoyue Qian_2019_QJEP/Haoyue Qian_2019_QJEP_Exp1_raw.csv"
  ) %>%
  tidyr::separate(
    condition,
...
summary(df[[4]])
write.csv(x = df[[4]], file = "../../Clean_Data/Haoyue Qian_2019_QJEP/Haoyue Qian_2019_QJEP_Exp1_Clean.csv")
```
...
df[[5]] <- read.csv(
  "../../Raw_Data/Haoyue Qian_2019_QJEP/Haoyue Qian_2019_QJEP_Exp2_raw.csv"
  ) %>%
  tidyr::separate(
    condition1correct,
...
summary(df[[5]])
write.csv(x = df[[5]], file = "../../Clean_Data/Haoyue Qian_2019_QJEP/Haoyue Qian_2019_QJEP_Exp2_Clean.csv")
```
...
df[[6]] <- read.csv(
  "../../Raw_Data/Sarah Schäfer_2019_CP/Sarah Schäfer_2019_CP_Exp1_raw.csv"
  ) %>%
  dplyr::filter(
...
summary(df[[6]])
write.csv(x = df[[6]], file = "../../Clean_Data/Sarah Schäfer_2019_CP/Sarah Schäfer_2019_CP_Exp1_Clean.csv")
```
...
df[[7]] <- read.csv(
  "../../Raw_Data/Sarah Schäfer_2019_CP/Sarah Schäfer_2019_CP_Exp3_raw.csv"
  ) %>%
  dplyr::filter(
    Procedure == "RPproc"
  ) %>%
...
summary(df[[7]])
write.csv(x = df[[7]], file = "../../Clean_Data/Sarah Schäfer_2019_CP/Sarah Schäfer_2019_CP_Exp3_Clean.csv")
```
...
df[[8]] <- read.csv(
  "../../Raw_Data/Mateusz Woźniak_2018_PLOS/Mateusz Woźniak_2018_PLOS_Exp1_raw.csv"
  ) %>%
  dplyr::filter(
    PracticeMode == "No"
  ) %>%
...
summary(df[[8]])
write.csv(x = df[[8]], file = "../../Clean_Data/Mateusz Woźniak_2018_PLOS/Mateusz Woźniak_2018_PLOS_Exp1_Clean.csv")
```
...
df[[9]] <- read.csv(
  "../../Raw_Data/Mateusz Woźniak_2018_PLOS/Mateusz Woźniak_2018_PLOS_Exp2_raw.csv"
  ) %>%
  dplyr::filter(
    PracticeMode == "No"
  ) %>%
...
summary(df[[9]])
write.csv(x = df[[9]], file = "../../Clean_Data/Mateusz Woźniak_2018_PLOS/Mateusz Woźniak_2018_PLOS_Exp2_Clean.csv")
```
...
df[[10]] <- read.csv(
  "../../Raw_Data/Marius Golubickis_2021_AP/Marius Golubickis_2021_AP_Exp1_raw.csv"
  ) %>%
  dplyr::mutate(
    Subject = as.numeric(subject),
    Matching = case_when(
...
summary(df[[10]])
write.csv(x = df[[10]], file = "../../Clean_Data/Marius Golubickis_2021_AP/Marius Golubickis_2021_AP_Exp1_Clean.csv")
```
...
summary(df[[11]])
write.csv(x = df[[11]], file = "../../Clean_Data/Marius Golubickis_2021_AP/Marius Golubickis_2021_AP_Exp2_Clean.csv")
```
...
df[[12]] <- read.csv(
  "../../Raw_Data/Mayan Navon_2021/Mayan Navon_2021_Exp1_raw.csv"
  ) %>%
  dplyr::select(
    Subject,
    Shape = Stimulus,
...
summary(df[[12]])
write.csv(x = df[[12]], file = "../../Clean_Data/Mayan Navon_2021/Mayan Navon_2021_Exp1_Clean.csv")
```
...
df[[13]] <- read.csv(
  "../../Raw_Data/Mayan Navon_2021/Mayan Navon_2021_Exp3_raw.csv"
  ) %>%
  dplyr::select(
    Subject,
    Shape = Stimulus,
...
summary(df[[13]])
write.csv(x = df[[13]], file = "../../Clean_Data/Mayan Navon_2021/Mayan Navon_2021_Exp3_Clean.csv")
```
...
df[[14]] <- read.csv(
  "../../Raw_Data/Mayan Navon_2021/Mayan Navon_2021_Exp4_raw.csv"
  ) %>%
  dplyr::select(
    Subject,
    Shape = Stimulus,
...
summary(df[[14]])
write.csv(x = df[[14]], file = "../../Clean_Data/Mayan Navon_2021/Mayan Navon_2021_Exp4_Clean.csv")
```
...
df[[15]] <- read.csv(
  "../../Raw_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp1_raw.csv"
  ) %>%
  dplyr::select(
    Subject = Participant..,
    Matching = Trial.Type,
...
summary(df[[15]])
write.csv(x = df[[15]], file = "../../Clean_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp1_Clean.csv")
```
...
df[[16]] <- read.csv(
  "../../Raw_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp2_raw.csv"
  ) %>%
  dplyr::select(
    Subject = Participant,
    Matching = Trial.Type,
...
summary(df[[16]])
write.csv(x = df[[16]], file = "../../Clean_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp2_Clean.csv")
```
...
df[[17]] <- read.csv(
  "../../Raw_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp3_raw.csv"
  ) %>%
  dplyr::select(
    Subject = Participant,
    Matching = Trial.Type,
...
summary(df[[17]])
write.csv(x = df[[17]], file = "../../Clean_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp3_Clean.csv")
```
...
df[[18]] <- read.csv(
  "../../Raw_Data/Yang Xu_2021_CP/Yang Xu_2021_CP_Exp1_raw.csv"
  ) %>%
  dplyr::select(
    Subject = Subject,
...
summary(df[[18]])
write.csv(x = df[[18]], file = "../../Clean_Data/Yang Xu_2021_CP/Yang Xu_2021_CP_Exp1_Clean.csv")
```
...
df_Ps1_E1 <- read.csv(
  "../../Raw_Data/Tuo Liu_2023_CP/Tuo Liu_2023_CP_Exp1_raw.csv"
  ) %>%
  dplyr::select(
...
summary(df[[19]])
write.csv(x = df[[19]], file = "../../Clean_Data/Tuo Liu_2023_CP/Tuo Liu_2023_CP_Exp1_Clean.csv")
```

```{r}
df[[19]] <- read.csv("../../Clean_Data/Tuo Liu_2023_CP/Tuo Liu_2023_CP_Exp1_Clean.csv") %>%
  dplyr::filter(
...
df[[20]] <- read.csv(
  "../../Raw_Data/Paper_s2/Ps2_Exp1_raw.csv"
  ) %>%
  dplyr::filter(
    Session != 3,
