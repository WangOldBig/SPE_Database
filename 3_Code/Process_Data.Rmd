...
df[[2]] <- read.csv(
  "../1_Clean_Data/Constable_2020_CE/Exp1/Constable_2020_CE_Exp1_Clean.csv"
  ) %>%
  # 筛选可以分析的行
  dplyr::filter(
    rt != "None",
...
df[[3]] <- read.csv(
  "../1_Clean_Data/Constable_2020_CE/Exp2/Constable_2020_CE_Exp2_Clean.csv"
  ) %>%
  # 筛选可以分析的行
  dplyr::filter(
    rt != "None",
...
write.csv(
  x = combined_data, 
  file = "../1_Clean_Data/Woźniak_2022_PR/Woźniak_2022_PR_Exp1_Clean.csv",
  row.names = FALSE
)
...
write.csv(
  x = combined_data, 
  file = "../1_Clean_Data/Woźniak_2022_PR/Woźniak_2022_PR_Exp2_Clean.csv",
  row.names = FALSE
)
...
write.csv(
  x = combined_data, 
  file = "../1_Clean_Data/Woźniak_2022_PR/Woźniak_2022_PR_Exp3_Clean.csv",
  row.names = FALSE
)
