...
df[[1]] <- read.csv(
  "../2_Raw_Data/Merryn D. Constable_2020_AP/MerrynD.Constable_2020_AP_Exp1_raw.csv"
  ) %>%
  dplyr::filter(
    rt != "None"
  ) %>%
  ...
  dplyr::select(
    Subject, Shape, Label, Matching, Identity, ShapeLoc, RT_ms, RT_sec, ACC, Phase
  ) %>%
  dplyr::mutate(
...
names(df)[1] <- "Merryn D. Constable_2020_AP Exp 1"
summary(df[[1]])
write.csv(x = df[[1]], file = "../1_Clean_Data/Merryn D. Constable_2020_AP/Merryn D. Constable_2020_AP_Exp1_Clean.csv")
```
...
df[[2]] <- read.csv(
  "../2_Raw_Data/Merryn Dale Constable_2020_CE/Exp1/Merryn Dale Constable_2020_CE_Exp1_raw.csv"
  ) %>%
  # 筛选可以分析的行
  dplyr::filter(
    rt != "None",
...
names(df)[2] <- "Merryn Dale Constable_2020_CE Exp 1"
summary(df[[2]])
write.csv(x = df[[2]], file = "../1_Clean_Data/Merryn Dale Constable_2020_CE/Merryn Dale Constable_2020_CE_Exp1_Clean.csv")
```
...
df[[3]] <- read.csv(
  "../2_Raw_Data/Merryn Dale Constable_2020_CE/Exp2/Merryn Dale Constable_2020_CE_Exp2_raw.csv"
  ) %>%
  # 筛选可以分析的行
  dplyr::filter(
    rt != "None",
...
names(df)[3] <- "Merryn Dale Constable_2020_CE Exp 2"
summary(df[[3]])
write.csv(x = df[[3]], file = "../1_Clean_Data/Merryn Dale Constable_2020_CE/Merryn Dale Constable_2020_CE_Exp2_Clean.csv")
```
...
df[[4]] <- read.csv(
  "../2_Raw_Data/Haoyue Qian_2019_QJEP/Haoyue Qian_2019_QJEP_Exp1_raw.csv"
  ) %>%
  tidyr::separate(
    condition,
...
names(df)[4] <- "Haoyue Qian_2019_QJEP Exp 1"
summary(df[[4]])
write.csv(x = df[[4]], file = "../1_Clean_Data/Haoyue Qian_2019_QJEP/Haoyue Qian_2019_QJEP_Exp1_Clean.csv")
```
...
df[[5]] <- read.csv(
  "../2_Raw_Data/Haoyue Qian_2019_QJEP/Haoyue Qian_2019_QJEP_Exp2_raw.csv"
  ) %>%
  tidyr::separate(
    condition1correct,
...
names(df)[5] <- "Haoyue Qian_2019_QJEP Exp 2"
summary(df[[5]])
write.csv(x = df[[5]], file = "../1_Clean_Data/Haoyue Qian_2019_QJEP/Haoyue Qian_2019_QJEP_Exp2_Clean.csv")
```
...
df[[6]] <- read.csv(
  "../2_Raw_Data/Sarah Schäfer_2019_CP/Sarah Schäfer_2019_CP_Exp1_raw.csv"
  ) %>%
  dplyr::filter(
...
names(df)[6] <- "Sarah Schäfer_2019_CP Exp 1"
summary(df[[6]])
write.csv(x = df[[6]], file = "../1_Clean_Data/Sarah Schäfer_2019_CP/Sarah Schäfer_2019_CP_Exp1_Clean.csv")
```
...
df[[7]] <- read.csv(
  "../2_Raw_Data/Sarah Schäfer_2019_CP/Sarah Schäfer_2019_CP_Exp3_raw.csv"
  ) %>%
  dplyr::filter(
    Procedure == "RPproc"
  ) %>%
...
names(df)[7] <- "Sarah Schäfer_2019_CP Exp 3"
summary(df[[7]])
write.csv(x = df[[7]], file = "../1_Clean_Data/Sarah Schäfer_2019_CP/Sarah Schäfer_2019_CP_Exp3_Clean.csv")
```
...
df[[8]] <- read.csv(
  "../2_Raw_Data/Mateusz Woźniak_2018_PLOS/Mateusz Woźniak_2018_PLOS_Exp1_raw.csv"
  ) %>%
  dplyr::filter(
    PracticeMode == "No"
  ) %>%
...
names(df)[8] <- "Mateusz Woźniak_2018_PLOS Exp 1"
summary(df[[8]])
write.csv(x = df[[8]], file = "../1_Clean_Data/Mateusz Woźniak_2018_PLOS/Mateusz Woźniak_2018_PLOS_Exp1_Clean.csv")
```
...
df[[9]] <- read.csv(
  "../2_Raw_Data/Mateusz Woźniak_2018_PLOS/Mateusz Woźniak_2018_PLOS_Exp2_raw.csv"
  ) %>%
  dplyr::filter(
    PracticeMode == "No"
  ) %>%
...
names(df)[9] <- "Mateusz Woźniak_2018_PLOS Exp 2"
summary(df[[9]])
write.csv(x = df[[9]], file = "../1_Clean_Data/Mateusz Woźniak_2018_PLOS/Mateusz Woźniak_2018_PLOS_Exp2_Clean.csv")
```
...
df[[10]] <- read.csv(
  "../2_Raw_Data/Marius Golubickis_2021_AP/Marius Golubickis_2021_AP_Exp1_raw.csv"
  ) %>%
  dplyr::mutate(
    Subject = as.numeric(subject),
    Matching = case_when(
...
names(df)[10] <- "Marius Golubickis_2021_AP Exp 1"
summary(df[[10]])
write.csv(x = df[[10]], file = "../1_Clean_Data/Marius Golubickis_2021_AP/Marius Golubickis_2021_AP_Exp1_Clean.csv")
```
...
names(df)[11] <- "Marius Golubickis_2021_AP Exp 2"
summary(df[[11]])
write.csv(x = df[[11]], file = "../1_Clean_Data/Marius Golubickis_2021_AP/Marius Golubickis_2021_AP_Exp2_Clean.csv")
```
...
df[[12]] <- read.csv(
  "../2_Raw_Data/Mayan Navon_2021/Mayan Navon_2021_Exp1_raw.csv"
  ) %>%
  dplyr::select(
    Subject,
    Shape = Stimulus,
...
names(df)[12] <- "Mayan Navon_2021 Exp 1"
summary(df[[12]])
write.csv(x = df[[12]], file = "../1_Clean_Data/Mayan Navon_2021/Mayan Navon_2021_Exp1_Clean.csv")
```
...
```{r Paper n13 Experiment 1}
# df[[14]] <- read.csv(
#   "../4_Data_Extraction/4_2_Open_Data/Paper_n13/2_Raw_Data/Pn13_Exp2_raw.csv"
#   ) %>%
#   dplyr::select(
#     Subject,
#     Shape = Stimulus,
...
# summary(df[[14]])
# write.csv(x = df[[14]], file = "../4_Data_Extraction/4_2_Open_Data/Paper_n13/1_Clean_Data/Pn13_Exp2_Clean.csv")
```
...
df[[13]] <- read.csv(
  "../2_Raw_Data/Mayan Navon_2021/Mayan Navon_2021_Exp3_raw.csv"
  ) %>%
  dplyr::select(
    Subject,
    Shape = Stimulus,
...
names(df)[13] <- "Mayan Navon_2021 Exp 3"
summary(df[[13]])
write.csv(x = df[[13]], file = "../1_Clean_Data/Mayan Navon_2021/Mayan Navon_2021_Exp3_Clean.csv")
```
...
df[[14]] <- read.csv(
  "../2_Raw_Data/Mayan Navon_2021/Mayan Navon_2021_Exp4_raw.csv"
  ) %>%
  dplyr::select(
    Subject,
    Shape = Stimulus,
...
names(df)[14] <- "Mayan Navon_2021 Exp 4"
summary(df[[14]])
write.csv(x = df[[14]], file = "../1_Clean_Data/Mayan Navon_2021/Mayan Navon_2021_Exp4_Clean.csv")
```
...
df[[15]] <- read.csv(
  "../2_Raw_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp1_raw.csv"
  ) %>%
  dplyr::select(
    Subject = Participant..,
    Matching = Trial.Type,
...
names(df)[15] <- "Saga L. Svensson_2021_PR Exp 1"
summary(df[[15]])
write.csv(x = df[[15]], file = "../1_Clean_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp1_Clean.csv")
```
...
df[[16]] <- read.csv(
  "../2_Raw_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp2_raw.csv"
  ) %>%
  dplyr::select(
    Subject = Participant,
    Matching = Trial.Type,
...
names(df)[16] <- "Saga L. Svensson_2021_PR Exp 2"
summary(df[[16]])
write.csv(x = df[[16]], file = "../1_Clean_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp2_Clean.csv")
```
...
df[[17]] <- read.csv(
  "../2_Raw_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp3_raw.csv"
  ) %>%
  dplyr::select(
    Subject = Participant,
    Matching = Trial.Type,
...
names(df)[17] <- "Saga L. Svensson_2021_PR Exp 3"
summary(df[[17]])
write.csv(x = df[[17]], file = "../1_Clean_Data/Saga L. Svensson_2021_PR/Saga L. Svensson_2021_PR_Exp3_Clean.csv")
```
...
df[[18]] <- read.csv(
  "../2_Raw_Data/Yang Xu_2021_CP/Yang Xu_2021_CP_Exp1_raw.csv"
  ) %>%
  dplyr::select(
    Subject = Subject,
...
names(df)[18] <- "Yang Xu_2021_CP Exp 1"
summary(df[[18]])
write.csv(x = df[[18]], file = "../1_Clean_Data/Yang Xu_2021_CP/Yang Xu_2021_CP_Exp1_Clean.csv")
```
...
df_Ps1_E1 <- read.csv(
  "../2_Raw_Data/Tuo Liu_2023_CP/Tuo Liu_2023_CP_Exp1_raw.csv"
  ) %>%
  dplyr::select(
...
names(df)[19] <- "Tuo Liu_2023_CP Exp 1"
summary(df[[19]])
write.csv(x = df[[19]], file = "../1_Clean_Data/Tuo Liu_2023_CP/Tuo Liu_2023_CP_Exp1_Clean.csv")
```

```{r}
df[[19]] <- read.csv("../1_Clean_Data/Tuo Liu_2023_CP/Tuo Liu_2023_CP_Exp1_Clean.csv") %>%
  dplyr::filter(
...
df[[20]] <- read.csv(
  "../2_Raw_Data/Paper_s2/Ps2_Exp1_raw.csv"
  ) %>%
  dplyr::filter(
    Session != 3,
