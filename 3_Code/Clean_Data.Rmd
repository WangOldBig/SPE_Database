...
# 读取CSV文件
data <- read.csv("../2_Raw_Data/Constable_2019_EPHPP/Exp2/Constable_2019_EPHPP_Exp2_raw.csv")
...
names(df)[23] <- "Vicovaro_2022_Exp1"
summary(df[[23]])
write.csv(x = df[[23]], file = "../1_Clean_Data/Vicovaro_2022/Vicovaro_2022_Exp1_Clean.csv")
```
# Paper t6
## Experiment 2 (Identtiy = 2)
"Self", "Stranger"
...
names(df)[24] <- "Vicovaro_2022_Exp2"
summary(df[[24]])
write.csv(x = df[[24]], file = "../1_Clean_Data/Vicovaro_2022/Vicovaro_2022_Exp2_Clean.csv")
```
# Perrykkad_2022_BMC
## Experiment 1 (Identtiy = 3)
"Self", "Friend", "Stranger"
...
names(df)[25] <- "Perrykkad_2022_BMC_Exp 1"
summary(df[[25]])
write.csv(x = df[[25]], file = "../1_Clean_Data/Perrykkad_2022_BMC/Perrykkad_2022_BMC_Exp1_Clean.csv")
```
