...
# 读取CSV文件
data <- read.csv("../2_Raw_Data/Svensson_2021_PR/Svensson_2021_PR_Exp1_raw.csv")
...
summary(df[[21]])
write.csv(x = df[[21]], file = "../4_Data_Extraction/4_2_Open_Data/Not_Good/Paper_s2/Ps2_Exp1_Clean.csv")
```
