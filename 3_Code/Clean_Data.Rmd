...
# 读取CSV文件
data <- read.csv("../2_Raw_Data/Zhang_2023_NI/Zhang_2023_NI_Exp1_raw.csv")
...
for (i in seq_along(data_files)) {
  ...
  # 确保数据包含所需变量
  if (all(c("RT_ms", "ACC", "English_Identity","Standarlized_Identity","Label_Identity", "Subject", "Matching", "Gender", "Age") %in% names(Data))) {
    ...
    Data <- Data %>%
      mutate(
        ...
        ACC = case_when(
            ACC %in% c(2, 3, 4) & is.na(RT_ms) ~ NA_real_,   # 未作答 → NA
            ACC %in% c(2, 3, 4) & !is.na(RT_ms) ~ 0,         # 错误 → 0
            TRUE ~ ACC                                        # 其他保持不变
          ),
    ...
    results_list[[counter]] <- Data %>%
      select(Source, Subject, Age, Gender, Matching, Standarlized_Identity, English_Identity, Label_Identity, RT_ms, ACC)  # **保留 Source 变量**
...
for (i in seq_along(data_files)) {
  ...
  if (all(c("RT_ms", "ACC", "English_Identity", "Standarlized_Identity", "Label_Identity",
            "Subject", "Matching", "Gender", "Age") %in% names(Data))) {
    ...
    Data <- Data %>%
      mutate(
        ...
        ACC = case_when(
          ACC %in% c(2, 3, 4) & is.na(RT_ms) ~ NA_real_,  # 未作答
          ACC %in% c(2, 3, 4) & !is.na(RT_ms) ~ 0,         # 错误
          TRUE ~ ACC
        )
      ) %>%
      filter(RT_ms > 0)
    ...
    results_list[[counter]] <- Data %>%
      select(Source, Subject, Age, Gender, Matching, Standarlized_Identity,
             English_Identity, Label_Identity, RT_ms, ACC)
    counter <- counter + 1
  }
  print(paste('完成数据集', i, '处理'))
}
...
# 合并所有数据
results <- bind_rows(results_list)
write_csv(results, "Processed_Data_by_age&gender.csv")
print("初步处理完成：Processed_Data_by_age&gender.csv 已保存")
...
# 找出准确率低于 50% 的被试
excluded_subjects <- acc_summary %>%
  filter(Accuracy < 0.5)

# 保存排除的被试信息
write_csv(excluded_subjects, "Exclude_Sub.csv")
print("准确率低于50%的被试已排除并保存到 Exclude_Sub.csv")
...
filtered_data <- filtered_data %>%
  mutate(log_RT_ms = log(RT_ms))

# 检查 log_RT_ms 的基本情况
summary(filtered_data$log_RT_ms)

### ========== 第五步：保存最终数据 ==========

write_csv(filtered_data, "Processed_Data_Filtered_with_logRT.csv")
print("最终数据已保存为 Processed_Data_Filtered_with_logRT.csv")
...
summary(df[[1]])
write.csv(x = df[[1]], file = "../1_Clean_Data/Constable_2020_AP/Constable_2020_AP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[2]])
write.csv(x = df[[2]], file = "../1_Clean_Data/Constable_2020_CE/Constable_2020_CE_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[3]])
write.csv(x = df[[3]], file = "../1_Clean_Data/Constable_2020_CE/Constable_2020_CE_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[4]])
write.csv(x = df[[4]], file = "../1_Clean_Data/Qian_2019_QJEP/Qian_2019_QJEP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[5]])
write.csv(x = df[[5]], file = "../1_Clean_Data/Qian_2019_QJEP/Qian_2019_QJEP_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[6]])
write.csv(x = df[[6]], file = "../1_Clean_Data/Schaefer_2019_CP/Schaefer_2019_CP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[7]])
write.csv(x = df[[7]], file = "../1_Clean_Data/Schaefer_2019_CP/Schaefer_2019_CP_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[8]])
write.csv(x = df[[8]], file = "../1_Clean_Data/Schaefer_2019_CP/Schaefer_2019_CP_Exp3_Clean.csv",row.names = FALSE)
```
...
summary(df[[9]])
write.csv(x = df[[9]], file = "../1_Clean_Data/Wozniak_2018_PLOS/Wozniak_2018_PLOS_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[10]])
write.csv(x = df[[10]], file = "../1_Clean_Data/Wozniak_2018_PLOS/Wozniak_2018_PLOS_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[11]])
write.csv(x = df[[11]], file = "../1_Clean_Data/Golubickis_2021_AP/Golubickis_2021_AP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[13]])
write.csv(x = df[[13]], file = "../1_Clean_Data/Navon_2021/Navon_2021_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[14]])
write.csv(x = df[[14]], file = "../1_Clean_Data/Navon_2021/Navon_2021_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[15]])
write.csv(x = df[[15]], file = "../1_Clean_Data/Navon_2021/Navon_2021_Exp3_Clean.csv",row.names = FALSE)
```
...
summary(df[[16]])
write.csv(x = df[[16]], file = "../1_Clean_Data/Navon_2021/Navon_2021_Exp4_Clean.csv",row.names = FALSE)
```
...
summary(df[[17]])
write.csv(x = df[[17]], file = "../1_Clean_Data/Svensson_2021_PR/Svensson_2021_PR_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[18]])
write.csv(x = df[[18]], file = "../1_Clean_Data/Svensson_2021_PR/Svensson_2021_PR_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[19]])
write.csv(x = df[[19]], file = "../1_Clean_Data/Svensson_2021_PR/Svensson_2021_PR_Exp3_Clean.csv",row.names = FALSE)
```
...
summary(df[[20]])
write.csv(x = df[[20]], file = "../1_Clean_Data/Xu_2021_CP/Xu_2021_CP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[21]])
write.csv(x = df[[21]], file = "../1_Clean_Data/Hu_2023/Hu_2023_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[22]])
write.csv(x = df[[22]], file = "../1_Clean_Data/Constable_2019_EPHPP/Exp1/Constable_2019_EPHPP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[23]])
write.csv(x = df[[23]], file = "../1_Clean_Data/Constable_2019_EPHPP/Exp2/Constable_2019_EPHPP_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[24]])
write.csv(x = df[[24]], file = "../1_Clean_Data/Constable_2019_EPHPP/Exp3/Constable_2019_EPHPP_Exp3_Clean.csv",row.names = FALSE)
```
...
summary(df[[25]])
write.csv(x = df[[25]], file = "../1_Clean_Data/Constable_2019_EPHPP/Exp4/Constable_2019_EPHPP_Exp4_Clean.csv",row.names = FALSE)
```
...
summary(df[[26]])
write.csv(x = df[[26]], file = "../1_Clean_Data/Vicovaro_2022_EPHPP/Vicovaro_2022_EPHPP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[27]])
write.csv(x = df[[27]], file = "../1_Clean_Data/Vicovaro_2022_EPHPP/Vicovaro_2022_EPHPP_Exp2_Clean.csv",row.names = FALSE)
rm(Subject_ID,temp)
```
...
summary(df[[28]])
write.csv(x = df[[28]], file = "../1_Clean_Data/Perrykkad_2022_BMC/Perrykkad_2022_BMC_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[29]])
write.csv(x = df[[29]], file = "../1_Clean_Data/Hu_2020_CP/Hu_2020_CP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[30]])
write.csv(x = df[[30]], file = "../1_Clean_Data/Wozniak_2022_PR/Wozniak_2022_PR_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[31]])
write.csv(x = df[[31]], file = "../1_Clean_Data/Wozniak_2022_PR/Wozniak_2022_PR_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[32]])
write.csv(x = df[[32]], file = "../1_Clean_Data/Wozniak_2022_PR/Wozniak_2022_PR_Exp3_Clean.csv",row.names = FALSE)
```
...
summary(df[[33]])
write.csv(x = df[[33]], file = "../1_Clean_Data/Haciahmet_2023_Psy/Haciahmet_2023_Psy_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[34]])
write.csv(x = df[[34]], file = "../1_Clean_Data/Sui_2023_CC/Sui_2023_CC_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[35]])
write.csv(x = df[[35]], file = "../1_Clean_Data/Hobbs_2023_PM/Hobbs_2023_PM_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[36]])
write.csv(x = df[[36]], file = "../1_Clean_Data/Mcivor_2020_EJN/Mcivor_2020_EJN_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[37]])
write.csv(x = df[[37]], file = "../1_Clean_Data/Liang_2022_HBM/Liang_2022_HBM_Exp1.1_Clean.csv",row.names = FALSE)
```
...
summary(df[[38]])
write.csv(x = df[[38]], file = "../1_Clean_Data/Kolvoort_2020_HBM/Kolvoort_2020_HBM_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[39]])
write.csv(x = df[[39]], file = "../1_Clean_Data/Liu_2023_CP/Liu_2023_CP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[40]])
write.csv(x = df[[40]], file = "../1_Clean_Data/Orellana-Corrales_2021_EP/Orellana-Corrales_2021_EP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[41]])
write.csv(x = df[[41]], file = "../1_Clean_Data/Orellana-Corrales_2021_EP/Orellana-Corrales_2021_EP_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[42]])
write.csv(x = df[[42]], file = "../1_Clean_Data/Orellana-Corrales_2021_EP/Orellana-Corrales_2021_EP_Exp3_Clean.csv",row.names = FALSE)
```
...
summary(df[[43]])
write.csv(x = df[[43]], file = "../1_Clean_Data/Amodeo_2024_CABN/Amodeo_2024_CABN_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[44]])
write.csv(x = df[[44]], file = "../1_Clean_Data/Zhang_2023_NI/Zhang_2023_NI_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[45]])
write.csv(x = df[[45]], file = "../1_Clean_Data/Feldborg_2021_ERPH/Feldborg_2021_ERPH_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[46]])
write.csv(x = df[[46]], file = "../1_Clean_Data/Martinez-Perez_2024_CC/Martinez-Perez_2024_CC_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[47]])
write.csv(x = df[[47]], file = "../1_Clean_Data/Wang_2016_EPHPP/Wang_2016_EPHPP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[48]])
write.csv(x = df[[48]], file = "../1_Clean_Data/Sui_2014/Sui_2014_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[49]])
write.csv(x = df[[49]], file = "../1_Clean_Data/Sui_2015/Sui_2015_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[50]])
write.csv(x = df[[50]], file = "../1_Clean_Data/Sui_2015/Sui_2015_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[51]])
write.csv(x = df[[51]], file = "../1_Clean_Data/Dalmaso_2024_CC/Dalmaso_2024_CC_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[52]])
write.csv(x = df[[52]], file = "../1_Clean_Data/Dalmaso_2024_CC/Dalmaso_2024_CC_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[53]])
write.csv(x = df[[53]], file = "../1_Clean_Data/Bukowski_2021_AP/Bukowski_2021_AP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[54]])
write.csv(x = df[[54]], file = "../1_Clean_Data/Bukowski_2021_AP/Bukowski_2021_AP_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[55]])
write.csv(x = df[[55]], file = "../1_Clean_Data/Svensson_2023_QJEP/Svensson_2023_QJEP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[56]])
write.csv(x = df[[56]], file = "../1_Clean_Data/Kirk_2025_BJP/Kirk_2025_BJP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[57]])
write.csv(x = df[[57]], file = "../1_Clean_Data/Kirk_2025_BJP/Kirk_2025_BJP_Exp2_Clean.csv",row.names = FALSE)
```

# Lee_2023_Cognition
## Experiment 1 (Identity = 2)
"Self", "Friend","Other"   →   "Self","Close","Stranger" (No Trial Message)
...
df[[58]] <- read.csv(
  ...
  dplyr::mutate(
    ...
    ACC = as.numeric(ACC),
    Label_Identity = case_when(
      Label_Identity == "you" ~ "You",
      Label_Identity == "friend" ~ "Friend",
      Label_Identity == "happy" ~ "NonPerson",
      Label_Identity == "neutral" ~ "NonPerson",
    ),
    English_Identity = case_when(
...
summary(df[[58]])
write.csv(x = df[[58]], file = "../1_Clean_Data/Lee_2023_Cognition/Lee_2023_Cognition_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[59]])
write.csv(x = df[[59]], file = "../1_Clean_Data/Lee_2023_Cognition/Lee_2023_Cognition_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[60]])
write.csv(x = df[[60]], file = "../1_Clean_Data/Sui_2014_APP/Sui_2014_APP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[61]])
write.csv(x = df[[61]], file = "../1_Clean_Data/Sui_2014_APP/Sui_2014_APP_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[62]])
write.csv(x = df[[62]], file = "../1_Clean_Data/Sui_2014_APP/Sui_2014_APP_Exp3_Clean.csv",row.names = FALSE)
```
...
summary(df[[63]])
write.csv(x = df[[63]], file = "../1_Clean_Data/Sui_2014_APP/Sui_2014_APP_Exp4_Clean.csv",row.names = FALSE)
```
...
df[[64]] <- read.csv(
  ...
  dplyr::select(
    ...
    Label_Identity, Origin_Identity, English_Identity, Standarlize_Identity,
    RT_ms, RT_sec, ACC
  ) %>%
  dplyr::arrange(
    Subject, Trial
...
summary(df[[64]])
write.csv(x = df[[64]], file = "../1_Clean_Data/Orellana-Corrales_2021_APP/Orellana-Corrales_2021_APP_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[65]])
write.csv(x = df[[65]], file = "../1_Clean_Data/Orellana-Corrales_2021_APP/Orellana-Corrales_2021_APP_Exp2_Clean.csv",row.names = FALSE)
```
...
summary(df[[66]])
write.csv(x = df[[66]], file = "../1_Clean_Data/Smith_2024_Cortex/Smith_2024_Cortex_Exp1_Clean.csv",row.names = FALSE)
```
...
summary(df[[67]])
write.csv(x = df[[67]], file = "../1_Clean_Data/Liang_2022_HBM/Liang_2022_HBM_Exp1.2_Clean.csv",row.names = FALSE)
```
...
summary(df[[68]])
write.csv(x = df[[68]], file = "../1_Clean_Data/Liang_2022_HBM/Liang_2022_HBM_Exp1.3_Clean.csv",row.names = FALSE)
```
