...
# 读取CSV文件
data <- read.csv("../2_Raw_Data/Dalmaso_2024_CC/Dalmaso_2024_CC_Exp1_raw.csv")
...
names(df)[54] <- "Paper 19 Exp 2"
summary(df[[54]])
write.csv(x = df[[54]], file = "../1_Clean_Data/Bukowski_2021_AP/Bukowski_2021_AP_Exp1_Clean.csv")
```
