...
rm(data_files, dataPath, file_name, has_age, has_age_gender, has_gender,i,names_with_age_gender,source_name)
```
...
"Self", "Mother","none", "Acquaintance"   →   "Self","Close","Acquaintance,"Non_Person"（No  trial message) (Flanker?)
