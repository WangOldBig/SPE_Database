...
# 读取CSV文件
data <- read.csv("../2_Raw_Data/Constable_2020_CE/Exp2/Constable_2020_CE_Exp2_raw.csv")
...
df[[2]] <- read.csv(
  ...
  dplyr::select(
    ...
    Shape, Label, Matching, Response, ShapeLoc, Colour, ShapeColour, textColour,
    Stimuli_Type, RT_ms, RT_sec, ACC
  ) %>%
  dplyr::mutate(
...
df[[3]] <- read.csv(
  ...
  dplyr::select(
    Subject, Gender, Age, Handedness, First_Lanugage,
    Shape, Label, Matching, Response, ShapeLoc, FaceIdentity, Stimulus,
