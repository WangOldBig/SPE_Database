...
# 读取CSV文件
data <- read.csv("../2_Raw_Data/Mcivor_2020_EJN/Mcivor_2020_EJN_Exp1_raw.csv")
...
df[[39]] <- read.csv(
  ...
  dplyr::select(
    Subject, Age, Handedness, Education, Firstlanguage, Countryparents, Countryparents, 
    Shape, Matching, Response, RT_ms, RT_sec, ACC
  ) %>%
  dplyr::mutate(
    RT_sec = round(RT_sec, 3),
    RT_ms = round(RT_ms, 0)
