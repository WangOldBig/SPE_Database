...
df[[8]] <- read.csv(
  ...
  dplyr::arrange(
    Subject, Matching, Origin_Identity, English_Identity, Standarlized_Identity,
  )
...
df[[9]] <- read.csv(
  ...
  dplyr::select(
    Subject, Matching, Origin_Identity, English_Identity, Standarlized_Identity, RT_ms, RT_sec, ACC, Face_Gender
  ) %>%
  dplyr::mutate(
    RT_sec = round(RT_sec, 3),
    RT_ms = round(RT_ms, 0)
...
df[[13]] <- read.csv(
  ...
  dplyr::select(
    Subject, Gender, Age, Handedness, First_Lanugage,
    Shape, Label, Matching, Origin_Identity, English_Identity, Standarlized_Identity, Response, RT_ms, RT_sec, ACC
  ) %>%
  dplyr::arrange(
    Subject, Matching, Origin_Identity
  )
...
df[[14]] <- read.csv(
  ...
  dplyr::arrange( 
    Subject, Origin_Identity, English_Identity, Standarlized_Identity, Matching
  )
...
df[[20]] <- read.csv(
  ...
  dplyr::arrange(
    Subject, Matching, Origin_Identity, English_Identity, Standarlized_Identity, Group
    )
...
df[[21]] <- read.csv(
  ...
  dplyr::select(
    ...
    Shape, Label, Matching, Origin_Identity, English_Identity, Standarlized_Identity,RT_ms, RT_sec, ACC
  ) %>%
  dplyr::mutate(
    RT_sec = round(RT_sec, 3),
    RT_ms = round(RT_ms, 0)
...
df[[22]] <- read.csv(
  ...
  dplyr::mutate(
    ...
    Standarlized_Identity = case_when(
      English_Identity == "Self" ~ "Self",
      English_Identity == "We" ~ "Group-Self",
      English_Identity == "They" ~ "Group-Stranger",
      English_Identity == "You" ~ "Stranger",
    ),
  ) %>%
  dplyr::mutate(
    RT_sec = round(RT_sec, 3),
...
df[[28]] <- read.csv(
  ...
  dplyr::select(
    Subject, Phase, Matching, Shape, Label, Response,  
...
df[[29]] <- read.csv(
  ...
  dplyr::arrange(
    Subject, Matching, Origin_Identity, English_Identity, Standarlized_Identity, Morality
    )
...
df[[35]] <- temp %>%
  ...
  dplyr::select(
    ...
    Treatment,
    Shape, Matching, Origin_Identity, English_Identity, Standarlized_Identity, RT_ms, RT_sec, ACC
  ) %>%
  dplyr::mutate(
    RT_sec = round(RT_sec, 3),
    RT_ms = round(RT_ms, 0)
...
df[[36]] <- read.csv(
  ...
  dplyr::select(
    ...
    Sadshapeother, Sadshapeself, Othershape, Selfshape, Label, Origin_Identity, English_Identity, Standarlized_Identity,
    Matching, Response, RT_ms, RT_sec, ACC
    ) %>%
  dplyr::mutate(
    RT_sec = round(RT_sec, 3),
...
df[[39]] <- df_Ps1_E1 %>%
  ...
  dplyr::select(
    Subject, Matching, Label, Response, Origin_Identity, English_Identity, Standarlized_Identity, RT_ms, RT_sec, ACC
  ) %>%
  dplyr::mutate(
    RT_sec = round(RT_sec, 3),
    RT_ms = round(RT_ms, 0)
