...
# 读取CSV文件
data <- read.csv("../2_Raw_Data/Constable_2020_AP/Constable_2020_AP_Exp1_raw.csv")
...
df[[1]] <- read.csv(
  ...
  dplyr::select(
    Subject, Age_Participant1, Age_Participant2, StrangerShape, P1Shape,
    P2Shape, Shape, Label, ShapeLoc, Response, Matching,RT_ms, RT_sec, ACC, 
    Phase
  ) %>%
  dplyr::arrange(
