...
df[[3]] <- read.csv(
  "../../4_Data_Extraction/4_2_Open_Data/Paper_46/Exp1/P46_Exp1_raw.csv"
  ) %>%
  # 筛选可以分析的行
  dplyr::filter(
    rt != "None",
...
summary(df[[3]])
write.csv(x = df[[3]], file = "../../4_Data_Extraction/4_2_Open_Data/Paper_46/Exp1/P46_Exp1_Clean.csv")
```
...
summary(df[[4]])
write.csv(x = df[[4]], file = "../../4_Data_Extraction/4_2_Open_Data/Paper_46/Exp2/P46_Exp2_Clean.csv")
```
...
summary(df[[5]])
write.csv(x = df[[5]], file = "./DATA/df_4.csv")
```
