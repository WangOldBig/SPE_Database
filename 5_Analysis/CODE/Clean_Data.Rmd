...
df[[5]] <- read.csv(
  ...
  dplyr::select(
    Subject, Matching, Identity, Session, RT_ms, RT_sec, ACC, Mood
  ) %>%
  dplyr::mutate(
    RT_sec = round(RT_sec, 3),
    RT_ms = round(RT_ms, 0)
...
summary(df[[5]])
write.csv(x = df[[5]], file = "../../4_Data_Extraction/4_2_Open_Data/Paper_51/P51_Exp1_Clean.csv")
```
...
summary(df[[6]])
write.csv(x = df[[6]], file = "../../4_Data_Extraction/4_2_Open_Data/Paper_51/P51_Exp2_Clean.csv")
```
