...
summary(df[[2]])
write.csv(x = df[[2]], file = "../../4_Data_Extraction/4_2_Open_Data/Paper_6/P6_Exp1_Clean.csv")
```
...
summary(df[[3]])
write.csv(x = df[[3]], file = "../../4_Data_Extraction/4_2_Open_Data/Paper_46/P46_Exp2_Clean.csv")
```
