...
## Overview
[how many papers's data was included, how many participants, how many variables, geographical distribution of participants]

## Storage and Access
The Self-Prioritization Effects Database is hosted on the [Open Science Framework (OSF)](https://osf.io/s46pr/). Each dataset is represented by two folders: **Raw_Data** and **Clean_Data**.
