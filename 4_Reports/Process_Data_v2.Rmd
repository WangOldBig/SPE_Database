...
names(df_Self_Mother)[2] <- "Qian_2019_QJEP Exp 2"
...
df[[5]] <- read.csv(
  "../1_Clean_Data/Schafer_2019_CP/Schafer_2019_CP_Exp1_Clean.csv"
  ) %>%
  # 添加新的环境变量
  dplyr::mutate(
...
df_Self_Mother[[3]] <- merged_list


names(df_Self_Mother)[3] <- "Schafer_2019_CP Exp1"
